...
def viewData():
    ...
    text_file_path = filedialog.askopenfilename(title="Choose Encrypted File", filetypes=(("Text Files", "*.txt"),))
...
heading_label = Label(root, text="Encryption & Decryption" , font = 'arial 10 italic', bg='~ADC698')
heading_label.place(relx=0.5,rely=0.2, anchor=CENTER)
btn_start_encryption= Button(root, text="Start Encryption", font = 'arial 13', bg="white", padx=10,command=startEncryption, relief=FLAT, padx=10)
btn_start_encryption.place(relx=0.3,rely=0.6, anchor=CENTER)
btn_start_decryption= Button(root, text="Start Decryption", font = 'arial 13', bg="white", padx=10,command=startDecryption, relief=FLAT, padx=10)
